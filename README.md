...
| 이현주 | - 아이디어 기획 및 팀빌딩 구성 <br> - 디자이너와 함께 플로우 기획 <br> - 전 페이지 UI/UX 레이아웃 마크업 작업 <br> - 회원가입 및 회원가입 절차 작업 <br> - 마이페이지 데이터 불러오기 <br> - 마이페이지 수정  <br> - 상태 관리 및 흐름 제어 <br> - 재사용 가능한 컴포넌트 구현                                                                                                                                                                                                                                                                                                                                         |
